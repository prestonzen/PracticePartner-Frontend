...
const SectionWithText = ({ title, text, buttonText, buttonLink, centerAligned }) => {
  return (
    <div className="flex justify-center my-20">
      <div className="max-w-xl w-full px-4 py-6 rounded-lg">
        ...
        <Link to={buttonLink} className={`bg-primary text-white font-bold text-sm rounded-full px-4 py-2 hover:bg-primary-light 
