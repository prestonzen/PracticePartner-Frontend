    ...
    try {
      ...
      await axios.post(
        ...
        {},
        {
          ...
          withCredentials: true, // Ensure cookies are included for server-side session clearing
          credentials: 'include', // Indicate CORS should include credentials
        }
      );

      // Handle successful logout on the frontend (optional)
      console.log('Logged out successfully');
      // Redirect to login page or a neutral landing page
